...
$('#search_tgl_awal, #tanggal, #tgl_lahir, #pengangkatan_tgl, #berhenti_tgl').datebox({  
        required:false  ,
...
function baru(){
			$('#dlg').dialog('open').dialog('setTitle','Tambah Data Aparat');
			$('#fm').form('clear');
...
function edit() {
	...
	if(row) { 
	$('#dlg').dialog('open').dialog('setTitle','Edit Data Aparat'); 
	$('#fm').form('load',row);						 
