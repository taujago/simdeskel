...
class pam extends CI_Model 
{
	...
	function get_data_per_tahun($tahun) {
		$this->db->where("year(pengangkatan_tgl) <= $tahun ",null,false);
    	$this->db->order_by("pengangkatan_tgl");
    	$res = $this->db->get("v_aparat");
    	return $res;
	}
