		...
		<thead>
			<tr>
                ...
                <th field='<?php echo $f8 ?>' width='100' sortable='true'><strong><?php echo $l8 ?></strong></th>
                ...
                <th field='<?php echo $f6 ?>' width='130' sortable='true'><strong><?php echo $l6 ?></strong></th>
                <th field='<?php echo $f7 ?>' width='170' sortable='true'><strong><?php echo $l7 ?></strong></th>
                <!---->
			</tr>
