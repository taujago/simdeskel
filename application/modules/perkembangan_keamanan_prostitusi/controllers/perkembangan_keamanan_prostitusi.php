<?php 
class perkembangan_keamanan_prostitusi extends op_controller {
...
$form['title1'] = 'Prostitusi';
$form['title2'] = 'prostitusi';
$form['table'] = 'perkembangan_keamanan_prostitusi';
$form['id'] = 'perkembangan_keamanan_prostitusi';
$form['f1'] = 'prostitusi';
$form['l1'] = 'Prostitusi';
$form['f2'] = 'ket_teks';
$form['l2'] = 'Keterangan';
