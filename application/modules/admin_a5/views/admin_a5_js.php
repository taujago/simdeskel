...
function baru(){
			$('#dlg').dialog('open').dialog('setTitle','Tambah Data Tanah Milik  <?php echo strtoupper($desa2->bentuk_lembaga) ?> / Kas <?php echo strtoupper($desa2->bentuk_lembaga) ?> ');
			$('#fm').form('clear');
...
function edit() {
	...
	if(row) { 
	$('#dlg').dialog('open').dialog('setTitle','Edit  Data Tanah Milik  <?php echo strtoupper($desa2->bentuk_lembaga) ?> / Kas <?php echo strtoupper($desa2->bentuk_lembaga) ?> '); 
	$('#fm').form('load',row);						 
