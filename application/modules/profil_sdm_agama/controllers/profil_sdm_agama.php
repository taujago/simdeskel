<?php 
class profil_sdm_agama extends op_controller {
	...
	function index(){
		...
		$form['title1'] = 'Agama / Aliran kepercayaan';
		$form['table'] = 'profil_sdm_agama';
		$form['id'] = 'profil_sdm_agama';
		$form['f1'] = 'agama';
		$form['l1'] = 'Agama';
		$form['f2'] = 'lk';
	...
	function get_data()
	{
		...
		$foot[0]['agama'] = "<strong>Jumlah</strong>";
