...
<span class="judul">DATA PENDUDUK BALITA  <br /></span><span class="judul"><?php echo  strtoupper($desa2->kota ) ?></span> <br />
...
<thead>
  <tr>
    ...
    <th width="19%" align="center" scope="col">Nama Ayah</th>
  </tr>
 </thead>
 <?php 
 $i =  0; 
 ...
 ?>
  <tr>
    ...
    <td width="19%"><?php echo $row->nama_ayah ?></td>
  </tr>
 <?php endforeach; ?>
</table>
