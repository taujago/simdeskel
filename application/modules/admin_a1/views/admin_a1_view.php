...
<table id="tt" class="easyui-datagrid" style="width:1135px;height:600px"
		...
		<thead frozen="true">
			<tr>
				...
				<th field="persetujuan_bpd_nomor" width="200" sortable="true"><strong>No. Persetujuan BPD  </strong></th>
			</tr>
		<thead>
			<tr>
				 <th field="persetujuan_bpd_tgl" width="200" sortable="true"><strong>Tgl. Persetujuan BPD </strong></th>
				<th field="dilaporkan_nomor" width="200" sortable="true"><strong>Nomor dilaporkan </strong></th>
