...
<br />
	...
	<legend>Biodata</legend>
		...
		<tr>
		  ...
		  <td>: 
	      <input type="text" name="regdate" id="regdate" class="text ui-widget-content ui-corner-all"  /></td>
		  </tr>
		<tr>
		<td width="200px">NIK   </td>
		<td>: <input name="nik" type="text" class="text ui-widget-content ui-corner-all" id="nik" size="50"  />
		  <a href="javascript:void(0)" onclick="get_temp_nik();">Generate NIK Sementara</a></td></tr>
		<tr>
		  <td >Masa Berlaku KTP s.d </td>
		  <td>: 
	      <input type="text" name="masa_berlaku_ktp" id="masa_berlaku_ktp" class="text ui-widget-content ui-corner-all"  /></td>
		  </tr>
		<tr>
		  <td >No. KK</td>
		  <td>: 
	      <input name="no_kk" type="text" class="text ui-widget-content ui-corner-all" id="no_kk" size="50"  /></td>
		  </tr>
		<tr>
		  <td >Kepala Keluarga</td>
		  <td>: <?php 
		  	$arr_kk = array(0=>"Tidak","Ya");
			echo form_dropdown("kepala_keluarga",$arr_kk,'','id="kepala_keluarga"');
		  ?></td>
		  </tr>
		<tr>
		  <td >Hubungan dalam Keluarga </td>
		  <td>: 
	      <input size="40" type="text" name="hubungan_dlm_keluarga" id="hubungan_dlm_keluarga" class="text ui-widget-content ui-corner-all"  /></td>
		  </tr>
		<!--<tr>
		  <td >Penduduk Miskin </td>
		  <td>: <?php echo form_dropdown("miskin",array(0=>"Tidak","Ya"),'',''); ?></td>
		  </tr>-->
		<tr><td >Nama   </td>
		...
		echo form_dropdown("jk",$arr_jk,'','id="jk"');?></td></tr>
...
,'','id="golongan_darah"');?></td></tr>
		...
		<tr><td >Pekerjaan   </td>
		<td>:  <?php echo form_dropdown("id_pekerjaan",$arr_pekerjaan,'','id="id_pekerjaan"');?>		 </td></tr>
		...
		echo form_dropdown("hidup_mati",$this->cm->arr_status_hidup,'','id="hidup_mati"');
		?></td></tr>
...
<fieldset id="pendatang">		
		...
		<table border="0" width="100%" > 
		<tr>
		  <td width="170">Jenis Kedatangan</td>
		  <td width="731">: <?php 
		...
		<tr class="dn"><td width="170">Alamat   </td>
		...
		<table border="0" width="100%" > 
		<tr><td width="186">Alamat   </td>
		<td width="715" valign="top">:  
		  <textarea name="alamat" id="alamat" 
        class="text ui-widget-content ui-corner-all" ></textarea> </td></tr>
 	   	<tr><td> <?php echo $this->dusun; ?> </td><td>: 
 	   	
 	   	    <input  type="text"  name="dusun" id="dusun" /></td>
 	   	</tr>
		<tr><td>RT/RW   </td>
...
<!-- SUKU DAN KETURUNAN  -->
		<fieldset>
			...
			<table border="0" width="100%">
				<tr>
					<td width="189">Suku </td>
				  <td width="712">: 
			      <input style="width:100px" type="text"  name="suku" id="suku" /> </td>
			  </tr>
				<tr>
					<td width="189">Keturunan </td>
				  <td>: <input  type="text" name="keturunan" id="keturunan" /> </td>
				</tr>
				<tr>
					<td width="189">Kebangsaan </td>
...
<!-- end of keturunan --> 
	...
	<!--	<fieldset><legend>Data Kartu Keluarga</legend>
		...
		<hr />
		<table border="0" width="100%" > 
		<tr><td   width="191">NIK Ayah  </td>
		  <td width="710">: 
		    <input   type="text" name="nik_ayah" id="nik_ayah" class="text ui-widget-content ui-corner-all"  />
		  </td></tr>
		<tr><td   width="191">Nama Ayah  </td>
		  <td>: <input   type="text" name="nama_ayah" id="nama_ayah" class="text ui-widget-content ui-corner-all"  />
		  </td></tr>
				
		<tr><td   width="191">NIK Ibu</td>
		  <td>: <input   type="text" name="nik_ibu" id="nik_ibu" class="text ui-widget-content ui-corner-all"  />
		  </td></tr>
				
		<tr><td   width="191">Nama Ibu</td>
...
function  get_temp_nik(){
	$.ajax({
		url : '<?php echo site_url("$controller/get_temp_nik"); ?>',
		success : function(tmp_nik) {
			$("#nik").val(tmp_nik);
		}
	});
}
