    ...
    <br />
		...
		<thead>
			<tr>
				...
				<th field="<?php echo $f2 ?>" width="170" sortable="true"><strong><?php echo $l2 ?></strong> </th>
				<th field="<?php echo $f4 ?>" width="170" sortable="true"><strong><?php echo $l4 ?></strong> </th>
                <th field="<?php echo $f3 ?>" width="170" sortable="true"><strong><?php echo $l3 ?></strong> </th>
                <th field="pemasaran_hasil" width="250" sortable="true"><strong>Pemasaran Hasil</strong> </th>
			</tr>
