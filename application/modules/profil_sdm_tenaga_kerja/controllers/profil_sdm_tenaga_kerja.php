<?php 
class profil_sdm_tenaga_kerja extends op_controller {
	...
	function index(){
		...
		$form['title1'] = 'Tenaga kerja';
		$form['title2'] = 'tenaga kerja';
		$form['table'] = 'profil_sdm_tenaga_kerja';
		$form['id'] = 'profil_sdm_tenaga_kerja';
		$form['f1'] = 'tenaga_kerja';
		$form['l1'] = 'Tenaga kerja';
		$form['f2'] = 'lk';
	...
	function get_data()
	{
		...
		$temp = $foot;
		$foot[0]['tenaga_kerja'] = "<strong>Jumlah</strong>";
