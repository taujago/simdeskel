...
$arr_penyakit = $this->cm->arr_tabel("master_penderita_sakit","id_penderita_sakit","penderita_sakit","penderita_sakit");
...
<br />
 ...
 <h3 class="judul"> PENYAKIT : <?php echo  $arr_penyakit[$id_jenis_penyakit]; ?></h3>
<BR />
 <table width="100%" border="0" class="tabel">
  <tr>
    <th width="4%" scope="col">No.</th>
    <th width="19%" scope="col">NIP / Nama</th>
    <th width="11%" scope="col">Alamat</th>
    <th width="12%" scope="col">Dusun</th>
     <th width="2%" scope="col">JK</th>
    <th width="10%" scope="col">Agama</th>
    <th width="14%" scope="col">Tmp / Tgl Lahir</th>
    <th width="4%" scope="col">Umur</th>
    <th width="11%" scope="col">Status Penduduk</th>
