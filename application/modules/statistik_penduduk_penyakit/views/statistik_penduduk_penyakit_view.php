...
<div id="tb" style="padding:5px;height:auto">
     ...
     Pilih Penyakit 
     <?php 
	 echo form_dropdown("id_jenis_penyakit",
	$this->cm->add_arr_head($this->cm->arr_tabel("master_jenis_penyakit","id_jenis_penyakit","jenis_penyakit","jenis_penyakit"),'x',' Pilih Jenis Penyakit '),'','id="id_jenis_penyakit" onchange="cari()"');
	 ?>
