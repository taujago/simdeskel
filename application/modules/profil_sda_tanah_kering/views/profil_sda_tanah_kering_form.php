<div id="dlg" class="easyui-dialog" style="width:600px;height:250px;padding:10px 10px"
		...
		<form id="fm" method="post" novalidate>			 
			<input type="hidden" name="id_tanah_kering" id="id_tanah_kering" />
		 	<fieldset >
			 <table>
				
				<tr>
			 		<td width="200px">Tanah Kering </td> 
			 		<td> : <input size="40" type="text" name="tanah_kering" id="tanah_kering" /></td>
			 	</tr>
                <tr>
