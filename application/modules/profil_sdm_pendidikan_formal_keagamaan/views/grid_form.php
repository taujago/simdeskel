<div id="dlg_<?php echo $id ?>" class="easyui-dialog" style="width:600px;height:400px;padding:10px 10px"
...
<tr>
<td width='200px'><?php echo $l9 ?> </td>
<td> : <?php $temp = explode('_teks',$f9); echo form_dropdown($temp[0], $arr9); ?></td>
</tr>
<tr>
...
<td> : <?php $temp = explode('_teks',$f4); echo form_dropdown($temp[0], $arr4); ?></td>
</tr>
<tr>
<td width='200px'><?php echo $l5 ?> </td>
<td> : <?php $temp = explode('_teks',$f5); echo form_dropdown($temp[0], $arr5); ?></td>
</tr>
<tr>
<td width='200px'><?php echo $l6 ?> </td>
<td> : <?php $temp = explode('_teks',$f6); echo form_dropdown($temp[0], $arr6); ?></td>
</tr>
<tr>
...
<td> : <input size='40' type='text' name='<?php echo $f8 ?>' id='<?php echo $f8 ?>' /></td>
</tr>
<!---->
