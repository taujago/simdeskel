<?php 
class profil_sdm_pencaharian_pokok extends op_controller {
	...
	function index(){
		...
		$form['title1'] = 'Mata pencaharian pokok';
		$form['title2'] = '';
		$form['table'] = 'profil_sdm_pencaharian_pokok';
		$form['id'] = 'profil_sdm_pencaharian_pokok';
		$form['f1'] = 'pekerjaan';
		$form['l1'] = 'Jenis pekerjaan';
		$form['f2'] = 'lk';
		...
		//$this->load->view("grid/grid_toolbar",$form);
	...
	function get_data()
	{
		...
		$temp[0]['pekerjaan'] = "<strong>Jumlah total penduduk</strong>";
		$temp[0]['pr'] = intval($foot[0]['lk'])+intval($foot[0]['pr']);
		$temp[0]['pr'] = "<strong>".$temp[0]['pr']."</strong>";
		$responce->footer = $temp;
