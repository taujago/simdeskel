<div id="dlg" class="easyui-dialog" style="width:600px;height:250px;padding:10px 10px"
		...
		<form id="fm" method="post" novalidate>			 
			<input type="hidden" name="id_luas_wilayah" id="id_luas_wilayah" />
		 	<fieldset >
			 <table>
				
				<tr>
			 		<td width="200px">Luas Wilayah Menurut Penggunaan </td> 
			 		<td> : <input size="40" type="text" name="luas_wilayah" id="luas_wilayah" /></td>
			 	</tr>
                <tr>
