...
?>
<body>
<!--<h1 class="judul">DATA PENDUDUK USIA LANJUT <?php echo  strtoupper($desa2->bentuk_lembaga. " " . $desa2->desa); ?></h1>
...
<span class="judul">DATA PENDUDUK USIA LANJUT<br /></span><span class="judul"><?php echo  strtoupper($desa2->kota ) ?></span> <br />
...
<br />
 ...
 <table width="100%" border="0" cellpadding="3" class="cetak">
   <thead>
     <tr>
       ...
       <th width="14%" align="center" scope="col">NIP / Nama</th>
 ...
 ?>
   <tr>
     ...
     <td width="14%"><?php echo $row->nik . "<Br />" . $row->nama; ?></td>
