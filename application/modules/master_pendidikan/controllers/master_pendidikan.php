<?php 
class master_pendidikan extends op_controller {
	...
	function index(){
		...
		$data['header'] = "Tingkat Pendidikan";
	...
	function get_data(){
        ...
        $sidx = isset($_REQUEST['sort'])?$_REQUEST['sort']:"id_pendidikan"; // get index row - i.e. user click to sort 
    ...
    function update() {
        ...
        $this->form_validation->set_rules('pendidikan','Jenjang pendidikan ','required');    
...
//				$data['hubungan'] = 
                ...
                $res = $this->db->insert("pendidikan",$data);
...
function hapus(){
    ...
    foreach($ids as $id) {
        ...
        $this->db->update("pendidikan",array("deleted"=>1));
