...
function baru(){
			$('#dlg').dialog('open').dialog('setTitle','Tambah Data Inventaris ');
			$('#fm').form('clear');
...
function edit() {
	...
	if(row) { 
	$('#dlg').dialog('open').dialog('setTitle','Edit Data Inventaris'); 
	$('#fm').form('load',row);						 
