<?php 
class profil_sda_pemasaran_hasil_galian extends op_controller {
	...
	function index(){
		...
		$form['title1'] = "Pemasaran Hasil Bahan Galian";
		$form['f1'] = "pemasaran_hasil";
		$form['f2'] = "keterangan";
		$form['l1'] = "Pemasaran Hasil";
		$form['l2'] = "Keterangan";
		$form['url'] = $data['controller']."/get_data";
		$form['table'] = "profil_sda_pemasaran_hasil_bahan_galian";
