...
$('#tanggal, #tanggal_lahir, #tanggal_pengangkatan, #tanggal_pemberhentian,#search_tgl_awal').datebox({  
        required:false  ,
...
function baru(){
			$('#dlg').dialog('open').dialog('setTitle','Tambah Data Anggota Badan Permusyawaratan Desa ');
			$('#fm').form('clear');
...
function edit() {
	...
	if(row) { 
	$('#dlg').dialog('open').dialog('setTitle','Edit Data Anggota Badan Permusyawaratan Desa '); 
	$('#fm').form('load',row);						 
