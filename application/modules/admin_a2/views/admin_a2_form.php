<div id="dlg" class="easyui-dialog" style="width:900px;height:500px;padding:10px 10px"
		...
		<div class="title">Data Keputusan </div>
		<form id="fm" method="post" novalidate>			 
			<input type="hidden" name="id" id="id" />
		 	<fieldset >
		 		<legend><b>Data Keputusan</b></legend>
			 <table>
				...
				<tr>
			 	...
			 	<!--<tr>
			 		...
			 		<td> : <input type="text" name="persetujuan_bpd_nomor" id="persetujuan_bpd_nomor" /></td></td>
			 	</tr>
			 	<tr>
			 		...
			 		<td> : <input type="text" name="dilaporkan_nomor" id="dilaporkan_nomor" /></td></td>
			 	</tr>
			 	<tr>
