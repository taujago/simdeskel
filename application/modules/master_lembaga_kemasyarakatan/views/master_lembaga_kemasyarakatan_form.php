<div id="dlg" class="easyui-dialog" style="width:600px;height:200px;padding:10px 10px"
		...
		<form id="fm" method="post" novalidate>			 
			<input type="hidden" name="id_lembaga_kemasyarakatan" id="id_lembaga_kemasyarakatan" />
		 	<fieldset >
			 <table>
				
				<tr>
			 		<td width="200px">Lembaga Kemasyarakatan </td> 
			 		<td> : <input size="40" type="text" name="lembaga_kemasyarakatan" id="lembaga_kemasyarakatan" /></td>
			 	</tr>		 		 
