<?php 
class kota extends  master_controller {
	var $error;
	function __construct() {
		parent::__construct();
 
		$this->load->model("kotam","dm");
...
function index()
   ...
   * */
    ...
    $data['header'] = "Data Kota";
	$data['controller'] = "kota";
...
function update(){
		...
		$res  = $this->db->update("tiger_kota",$data);
...
function get_data(){
        ...
        $kota  = isset($_REQUEST['search_kota'])?$_REQUEST['search_kota']:"x";
        ...
        for($i=0; $i<count($result); $i++){
			...
			$responce->rows[$i]['kode_kota']= $result[$i]['kode_kota'] ; 
