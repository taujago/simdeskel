            ...
            <input type="hidden" class="<?php echo $id ?>" name="id" id="id" value="" />
			 ...
			 <table>
				...
				<tr>
			 		...
			 		<td> : <?php echo form_dropdown($f7, array("1"=>"Wisata","2"=>"Pengobatan","3"=>"Energi","4"=>"dll")); ?></td>
			 	</tr>
                <tr>
			 		<td width="200px"><?php echo $l4 ?> </td> 
			 		<td> : <?php echo form_dropdown($f8, array("1"=>"Ya","0"=>"Tidak")); ?></td>
			 	</tr>
                <tr>
			 		<td width="200px"><?php echo $l5 ?> </td> 
			 		<td> : <?php echo form_dropdown($f9, array("1"=>"Ya","0"=>"Tidak")); ?></td>
			 	</tr>
                <tr>
			 		<td width="200px"><?php echo $l6 ?> </td> 
			 		<td> : <?php echo form_dropdown($f10, array("1"=>"Adat","0"=>"Perorangan")); ?></td>
			 	</tr>
		 </table>
