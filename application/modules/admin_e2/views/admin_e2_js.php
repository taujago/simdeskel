...
$('#tanggal_keputusan,#search_tgl_awal').datebox({  
        required:false  ,
...
function baru(){
			$('#dlg').dialog('open').dialog('setTitle','Tambah Data Keputusan BPD ');
			$('#fm').form('clear');
...
function edit() {
	...
	if(row) { 
	$('#dlg').dialog('open').dialog('setTitle','Edit Data Keputusan BPD '); 
	$('#fm').form('load',row);						 
