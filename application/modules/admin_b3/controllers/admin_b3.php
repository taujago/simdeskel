...
function excel($tahun) {
    ...
    $this->load->library('Excel');
        ...
        $this->excel->getActiveSheet()->setTitle('buku data rekapitlasi ');
...
$baris+=3;
 $this->excel->getActiveSheet()         
        ...
        ->setCellValue('AD' . $baris, strtoupper($this->desa2->bentuk_lembaga. " ".$this->desa2->desa).", ".date("d-m-Y"));
 $baris++;
$this->excel->getActiveSheet()         
...
$this->excel->getActiveSheet()         
 ...
 $baris++;
$this->excel->getActiveSheet()
->setCellValue('ad' . $baris, "NIP : " . $this->desa2->nip_sek_desa);

$baris++;
$this->excel->getActiveSheet()
->setCellValue('ad' . $baris, "Pangkat  : " . $this->desa2->pangkat_sek_desa);
