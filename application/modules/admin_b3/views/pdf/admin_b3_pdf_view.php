...
<thead>
   ...
   <?php 
	...
	/*echo "<br />";
	//echo $this->db->last_query()."<br />"; 
	echo "wni l = $ab_wni_l <br />";
	echo "wni p = $ab_wni_p <br />";
	 echo "<hr />";*/
   ...
   <tr>
     ...
     <td align="center"><?php echo $ab_kk; ?></td>
     <td align="center"><?php echo $ab_wni_l; ?></td>
     <td align="center"><?php echo $ab_wni_p; ?></td>
     <td align="center"><?php echo $ab_wna_l;  ?></td>
     <td align="center"><?php echo $ab_wna_p;  ?></td>
     <td align="center"><?php echo $ab_jak; ?></td>
     <td align="center"><?php echo $jumlah_jiwa; ?></td>
     <td align="center"><?php echo $lahir_wni_l ?></td>
     <td align="center"><?php echo $lahir_wni_p ?></td>
     <td align="center"><?php echo $lahir_wna_l ?></td>
     <td align="center"><?php echo $lahir_wna_p ?></td>
     <td align="center"><?php echo $datang_wni_l ?></td>
     <td align="center"><?php echo $datang_wni_p ?></td>
     <td align="center"><?php echo $datang_wna_l ?></td>
     <td align="center"><?php echo $datang_wna_p ?></td>
     <td align="center"><?php echo $mati_wni_l ?></td>
     <td align="center"><?php echo $mati_wni_p ?></td>
     <td align="center"><?php echo $mati_wna_l ?></td>
     <td align="center"><?php echo $mati_wna_p ?></td>
     <td align="center"><?php echo $pindah_wni_l ?></td>
     <td align="center"><?php echo $pindah_wni_p ?></td>
     <td align="center"><?php echo $pindah_wna_l ?></td>
     <td align="center"><?php echo $pindah_wna_p ?></td>
     <td align="center"><?php echo $jumlah_wni_l ?></td>
     <td align="center"><?php echo $jumlah_wni_p ?></td>
     <td align="center"><?php echo $jumlah_wna_l ?></td>
     <td align="center"><?php echo $jumlah_wna_p ?></td>
     <td align="center"><?php echo $jumlah_kk ?></td>
     <td align="center"><?php echo $jumlah_warga ?></td>
     <td align="center"><?php echo ($jumlah_kk + $jumlah_warga) ?></td>
     <td>&nbsp;</td>
   </tr>  
<?php endforeach; ?>
</table>
