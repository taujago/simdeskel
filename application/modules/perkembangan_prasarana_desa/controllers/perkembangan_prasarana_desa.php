<?php 
class perkembangan_prasarana_desa extends op_controller {
...
$form['title2'] = '';
$form['table'] = 'perkembangan_prasarana_desa';
$form['id'] = 'perkembangan_prasarana_desa';
$form['f1'] = 'sarana';
$form['l1'] = 'Prasarana dan administrasi';
$form['f2'] = 'ket_teks';
$form['l2'] = 'Keterangan';
$form['arr2'] = array("1"=>"Ada","2"=>"Tidak");
$form['arr2'] = $this->cm->add_arr_head($form['arr2'],"0","Kosong");
$form['f3'] = 'kondisi_teks';
$form['l3'] = 'Kondisi';
