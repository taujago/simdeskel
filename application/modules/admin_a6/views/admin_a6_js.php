...
function baru(){
			$('#dlg').dialog('open').dialog('setTitle','Tambah Data Di  <?php echo strtoupper($desa2->bentuk_lembaga) ?>  ');
			$('#fm').form('clear');
...
function edit() {
	...
	if(row) { 
	$('#dlg').dialog('open').dialog('setTitle','Edit  Data Tanah Di  <?php echo strtoupper($desa2->bentuk_lembaga) ?>  '); 
	$('#fm').form('load',row);						 
