...
<div id="dlg" class="easyui-dialog" style="width:400px;height:400px;padding:10px 10px"
			closed="true" buttons="#dlg-buttons">
		 
         <div id="gambar" style="margin:0px auto; text-align:center; vertical-align:middle" >
