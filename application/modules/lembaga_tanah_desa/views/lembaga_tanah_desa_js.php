...
$('#search_tgl_awal, #tanggal, #tkd_tgl').datebox({  
        required:false  ,
...
function baru(){
			$('#dlg').dialog('open').dialog('setTitle','Tambah Data Tanah di Desa');
			$('#fm').form('clear');
...
function edit() {
	...
	if(row) { 
	$('#dlg').dialog('open').dialog('setTitle','Edit Data Tanah di Desa'); 
	$('#fm').form('load',row);						 
