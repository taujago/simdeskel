...
<table id="tt" class="easyui-datagrid" style="width:1135px;height:600px"
		...
		<thead frozen="true">
			<tr>
				...
				<th field="nama" width="100" sortable="true"><strong>Nama  </strong> </th>
				<th field="badan_hukum" width="200" sortable="true"><strong>Badan Hukum</strong> </th>
				<th field="luas" width="50" sortable="true"><strong>Luas </strong> </th>
				<th field="status_tanah2" width="150" sortable="true"><strong>Status Tanah</strong></th>
				<th field="sertifikat2" width="100" sortable="true"><strong>Sertifikat</strong></th>
                <th field="penggunaan2" width="100" sortable="true"><strong>Penggunaan</strong></th>
                <th field="keterangan" width="100" sortable="true"><strong>Keterangan</strong></th>
			</tr>
