<?php 
class profil_sdm_tni extends op_controller {
	...
	function index(){
		...
		$form['title1'] = 'Kerjasama desa/kelurahan dengan TNI - POLRI dalam bidang TRANTIBLINMAS';
		$form['title2'] = 'kerja sama';
		$form['table'] = 'profil_sdm_tni';
		$form['id'] = 'profil_sdm_tni';
		$form['f1'] = 'kerjasama';
		$form['l1'] = 'Kerjasama';
		$form['f2'] = 'ket_teks';
		$form['l2'] = 'Ada/Tidak';
