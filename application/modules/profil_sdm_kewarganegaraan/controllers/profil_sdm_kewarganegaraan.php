<?php 
class profil_sdm_kewarganegaraan extends op_controller {
	...
	function index(){
		...
		$form['title1'] = 'Kewarganegaraan';
		$form['title2'] = 'kewarganegaraan';
		$form['table'] = 'profil_sdm_kewarganegaraan';
		$form['id'] = 'profil_sdm_kewarganegaraan';
		$form['f1'] = 'warga';
		$form['l1'] = 'Kewarganegaraan';
		$form['f2'] = 'lk';
	...
	function get_data()
	{
		...
		$temp = $foot;
		$foot[0]['warga'] = "<strong>Jumlah</strong>";
