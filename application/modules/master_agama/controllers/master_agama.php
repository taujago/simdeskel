<?php 
class master_agama extends op_controller {
	function __construct(){
		parent::__construct();
		$this->load->model("core_model","cm");
		$this->load->model("ma","dm");
	}


	function index(){
		$data['controller'] = get_class($this);
		$data['header'] = "Agama & aliran kepercayaan";
	...
	function get_data(){
        ...
        $sidx = isset($_REQUEST['sort'])?$_REQUEST['sort']:"agama"; // get index row - i.e. user click to sort 
...
function hapus(){
    ...
    foreach($ids as $id) {
        ...
        $this->db->update("agama",array("deleted"=>1));
