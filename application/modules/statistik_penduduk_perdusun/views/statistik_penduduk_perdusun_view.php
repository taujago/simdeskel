<table id="tt" class="easyui-datagrid" style="width:1130px;height:600px"
...
<div id="tb" style="padding:5px;height:auto">
     ...
     Pilih Dusun 
     <?php 
	 echo form_dropdown("id_dusun",$this->cm->add_arr_head($this->cm->arr_dusun(),'x',' Semua Dusun'),'','id="id_dusun" onchange="cari()"');
	 ?>
