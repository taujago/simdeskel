<div style="display:none" id="tb_<?php echo $id ?>" style="padding:5px;height:auto">
	<div >
		...
		<a href="#" class="easyui-linkbutton easyui-tooltip" title="Tekan tombol ini untuk mengambil dan memasukkan data Jumlah penduduk tahun ini kedalam database serta mengkalkulasi persentase perkembangan penduduk" iconCls="icon-reload" plain="true" onclick="reload('<?php echo $id ?>')">Ambil data jumlah penduduk tahun ini dan kalkulasi</a>
		<br />
