...
<thead>
 ...
 ?>
  <tr>
    ...
    <td width="12%"><?php echo  $data['nama']; ?></td>
    <td width="3%"><?php echo $data['jk'] ?></td>
    <td width="5%"><?php echo $arr_status_kawin[$data['status_kawin']] ?></td>
    <td width="6%"><?php echo $data['tmp_lahir'] ?></td>
    <td width="6%"><?php echo $data['tgl_lahir'] ?></td>
    <td width="6%"><?php echo $data['agama'] ?></td>
    <td width="7%"><?php echo  $data['pendidikan']; //$arr_status_kependudukan[$data['status_kependudukan] ?></td>
    <td width="7%"><?php echo $data['pekerjaan'] ?></td>
    <td width="7%"><?php echo ($data['baca_tulis']=="1")?"Ya":"Tidak"; ?></td>
    <td width="7%"><?php echo $data['warga_negara'] ?></td>
    <td width="10%"><?php echo $data['alamat'] ?></td>
    <td width="5%"><?php echo $this->cm->kedudukan_dalam_keluarga($data['id_penduduk']);  ?></td>
