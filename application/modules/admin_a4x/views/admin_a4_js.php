...
$('#tgl_lahir, #pengangkatan_tanggal, #pemberhentian_tanggal').datebox({  
        required:false  ,
...
function baru(){
			$('#dlg').dialog('open').dialog('setTitle','Tambah Data Aparatur Pemerintah ');
			$('#fm').form('clear');
...
function edit() {
	...
	if(row) { 
	$('#dlg').dialog('open').dialog('setTitle','Edit Data Aparatur Pemerintah'); 
	$('#fm').form('load',row);						 
