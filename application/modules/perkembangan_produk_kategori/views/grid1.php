        <table id="tt_<?php echo $id ?>" class="easyui-datagrid" style="width:1135px;height:500px"
		...
		<thead>
			<tr>
                ...
                <th field='<?php echo $f2 ?>' width='300' sortable='true'><strong><?php echo $l2 ?></strong></th>
